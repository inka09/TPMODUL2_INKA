public class Handphone extends Perangkat{
    ...
    public void informasi(){
        if (this.fingerprint == false){
            System.out.println("Handphone ini memiliki drive tipe " + drive + 
            " dengan ram sebesar " + ram + " GB " + "dan processor secepat " + processor + " Ghz. "
            + "Selain itu handphone ini TIDAK memiliki fingerprint");
        }
        else{
            System.out.println("Handphone ini memiliki drive tipe " + drive + 
            " dengan ram sebesar " + ram + " GB " + "dan processor secepat " + processor + " Ghz. "
            + "Selain itu handphone ini memiliki fingerprint");
        }
    }
